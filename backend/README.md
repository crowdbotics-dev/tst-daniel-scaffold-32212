...
## Project Structure
    ...
    ├── tst_daniel_scaffold_32212  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_scaffold_32212`
...
2. Clone this repo and `cd tst_daniel_scaffold_32212`
